...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
  console.log('build-config.js: SUPABASE_URL or SUPABASE_ANON_KEY not set, skipping config.js (local or missing env).');
  process.exit(0);
}
...
const config = {
  ...
  STRIPE_CHURCH_MONTHLY_URL: process.env.STRIPE_CHURCH_MONTHLY_URL || '',
  STRIPE_CHURCH_YEARLY_URL: process.env.STRIPE_CHURCH_YEARLY_URL || '',
