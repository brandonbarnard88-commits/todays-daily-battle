(function () {
  ...
  function openDetail(id) {
    ...
    if (window.TdbKjvDictionary && typeof window.TdbKjvDictionary.applyToElement === 'function') {
      ...
      state.refs.note.textContent = item.note ? 'Note: ' + item.note : 'No note yet. Add one when you want to say why this verse matters today.';
  ...
  async function shareSelectedToChurch() {
    ...
    setStatus(copied ? 'Share text copied. Paste in Church hub.' : 'Share text did not copy. Try again.');
  }
