/**
 * 365 kid-friendly KJV verses + matching prayers for kids-battle.js
 * Public domain. Short, heroic, encouraging, kid-safe.
 * Editorial bar: uplifting and hope-forward (comfort, peace, joy, love, strength)—avoid
 * heaviness as the headline (affliction, judgment, sin, death) where a gentler KJV line fits.
 *
 * Home hero uses the same 365 sequence in /hero-daily-365-data.js (__TDB_HERO_DAILY_YEAR).
 * Order is calendar-mixed (non-Psalm verses spaced through the year) so daily reading
 * does not stack weeks of the same book. Consecutive days also avoid the same chapter
 * (Psalm 103:5 then Psalm 103:8 reads like yesterday). Same verse set — new order only.
 * If you edit this list, regenerate: node scripts/sync-hero-365-from-kids.mjs
 * To re-mix order: node scripts/redistribute-hero-365-calendar.mjs && node scripts/sync-hero-365-from-kids.mjs
 * To separate unpublished same-chapter days: node scripts/separate-hero-adjacent-chapters.mjs
 */
(function (global) {
  'use strict';
  global.__TDB_KIDS_VERSES_365 = [
  ...
  { ref: "Psalm 4:7", text: "Thou hast put gladness in my heart, more than in the time that their corn and their wine increased." },
  { ref: "2 Corinthians 9:8", text: "And God is able to make all grace abound toward you; that ye, having all sufficiency in all things, may abound to every good work." },
  ...
  { ref: "Psalm 63:5", text: "My soul shall be satisfied as with marrow and fatness; and my mouth shall praise thee with joyful lips." },
  ...
  { ref: "Psalm 119:24", text: "Thy testimonies also are my delight and my counsellors." },
  ...
  { ref: "Psalm 145:16", text: "Thou openest thine hand, and satisfiest the desire of every living thing." },
  { ref: "1 Peter 1:8", text: "Whom having not seen, ye love; in whom, though now ye see him not, yet believing, ye rejoice with joy unspeakable and full of glory." },
  ...
  { ref: "Psalm 33:1", text: "Rejoice in the Lord, O ye righteous: for praise is comely for the upright." },
  ...
  { ref: "Psalm 119:174", text: "I have longed for thy salvation, O Lord; and thy law is my delight." },
  ...
  { ref: "Psalm 119:111", text: "Thy testimonies have I taken as an heritage for ever: for they are the rejoicing of my heart." },
  ...
  { ref: "Psalm 119:151", text: "Thou art near, O Lord; and all thy commandments are truth." },
  ...
  { ref: "Isaiah 40:1", text: "Comfort ye, comfort ye my people, saith your God." },
