...
module.exports = {
  ...
  quizWrongHumilityHint:
    'Listen again — she poured out; and when there was not a vessel more, the oil stayed.',
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ['Much silver.', 'Save a pot of oil.', 'Many sheep.', 'New robes only.'],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: ['Stones only.', 'Empty vessels — borrow not a few.', 'Food only.', 'Nothing.'],
      correctIndex: 1,
  ...
  takeaway:
    'She poured the little oil God gave — and it filled every borrowed vessel until there were no more. Then she could pay her debt and care for her children.',
  prayer:
    'Lord, thank You for caring for families. Help us trust You with what feels small. Amen.',
  imagePrompts: [
