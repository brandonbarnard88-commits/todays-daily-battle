'use strict';
/**
 * Elisha and the Shunammite's son — 2 Kings 4:8-37 (KJV). Library key: elishaShunammite
 *
 * Tap-through: strict KJV for calm verses. Verses 19-20 and 31-32 (acute sickness / death on the bed)
 * are summarized in paragraphs only, not in interactive taps.
 */

module.exports = {
  kjvRef: '2 Kings 4:8-37 (KJV)',
  verseExcerpt:
    'And he called Gehazi, and said, Call this Shunammite. So he called her. And when she was come in unto him, he said, Take up thy son. — 2 Kings 4:36 (KJV)',
  readAlongTitle: 'Read along',
  quizWrongHumilityHint:
    'Listen again — the child sneezed seven times, and the child opened his eyes; and he said, Take up thy son.',
  ...
  questions: [
    {
      question: 'Where did the great woman live?',
      choices: ['Jericho only.', 'Shunem.', 'Egypt.', 'Nineveh.'],
      correctIndex: 1,
      correctFeedback: 'Elisha passed to Shunem, where was a great woman.',
      wrongFeedback: 'Listen for Shunem. (Answer: Shunem.)'
    },
    {
    ...
    },
    {
      ...
      choices: ['A lamb.', 'A son.', 'Gold only.', 'Nothing.'],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: ['The sea.', 'Mount Carmel.', 'Damascus.', 'Jericho only.'],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: ['Hide away.', 'Take up thy son.', 'Run faster.', 'Stay outside.'],
      correctIndex: 1,
  ...
  takeaway:
    'God used Elisha\u2019s prayer to bring life back — the Shunammite took up her son with joy.',
  prayer:
    'Lord, thank You for mercy. Help us trust You in hard moments. Amen.',
  imagePrompts: [
