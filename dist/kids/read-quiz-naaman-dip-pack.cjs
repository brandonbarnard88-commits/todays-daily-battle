'use strict';
/**
 * Naaman returns with thanks — 2 Kings 5:15-19 (KJV). Library key: naamanDip.
 *
 * Calm tap-through after the Jordan healing: thanks, refusal of payment, earth for the LORD,
 * humble request about the king’s house, Go in peace. (Gehazi’s story stays in other teaching.)
 */
...
module.exports = {
  ...
  prayer:
    'Lord, thank You for mercy we cannot buy. Teach us grateful hearts. Amen.',
  imagePrompts: [
