...
(function (global) {
  ...
  var MASCOT_POSES = [
    { src: '/kids/shepherd-mascot-welcome.png?v=20260810ears', label: 'Little Shepherd waves hello' },
    { src: '/kids/shepherd-mascot-point.png?v=20260810ears', label: 'Little Shepherd points the way' },
    { src: '/kids/shepherd-mascot-sheep.png?v=20260810ears', label: 'Little Shepherd with a small sheep' },
    { src: '/kids/shepherd-mascot-cheer.png?v=20260810ears', label: 'Little Shepherd cheering for you' },
    { src: '/kids/shepherd-mascot-sit.png?v=20260810ears', label: 'Little Shepherd sitting with a little lamb' },
    { src: '/kids/shepherd-mascot-listen.png?v=20260810ears', label: 'Little Shepherd listens with you' },
    { src: '/kids/shepherd-mascot-read.png?v=20260810ears', label: 'Little Shepherd with Scripture open' },
    { src: '/kids/shepherd-mascot-pray.png?v=20260810ears', label: 'Little Shepherd prays with you' },
    { src: '/kids/shepherd-mascot-proud.png?v=20260810ears', label: 'Little Shepherd is proud of you' },
    { src: '/kids/shepherd-mascot-comfort.png?v=20260810ears', label: 'Little Shepherd is still with you' },
    { src: '/kids/shepherd-mascot-wonder.png?v=20260810ears', label: 'Little Shepherd looks up in wonder' },
    { src: '/kids/shepherd-mascot-laugh.png?v=20260810ears', label: 'Little Shepherd laughs with you' },
    { src: '/kids/shepherd-mascot-point-excited.png?v=20260810ears', label: 'Little Shepherd points to your surprise story' },
    { src: '/kids/shepherd-mascot-arms-hurray.png?v=20260810ears', label: 'Little Shepherd celebrates your surprise with quiet joy' },
    { src: '/kids/shepherd-mascot-clap-soft.png?v=20260810ears', label: 'Little Shepherd is glad for your surprise pick' }
  ];
