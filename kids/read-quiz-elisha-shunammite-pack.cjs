'use strict';
/**
 * Elisha and the Shunammite’s son (gentle) — 2 Kings 4:8-37 (KJV). Library key: elishaShunammite
 *
 * Acute sickness and death (4:18-20) are told in paragraphs, not taps. Taps carry full KJV for the rest.
 */
...
module.exports = {
  ...
  quizWrongHumilityHint:
    'Listen again — the child sneezed seven times, opened his eyes, and Elisha said, Take up thy son.',
  ...
  readAlongSections: [
    ...
    {
      text:
        'Run now, I pray thee, to meet her, and say unto her, Is it well with thee? is it well with thy husband? is it well with the child? And she answered, It is well. Then she said, Did I desire a son of my lord? did I not say, Do not deceive me?',
