    ...
    questions: [
      {
        ...
        wrongFeedback:
          "Not quite. The Bible doesn't say to fight with swords or climb. God told them to march around quietly for six days, then seven times on the seventh day — that was the way to win! (Answer: March around the city quietly.)"
      },
      {
        ...
        wrongFeedback:
          "Let's check the story: God said to march around once each day for six days, but on the seventh day, march seven times. The answer is seven! (Answer: Seven times.)"
      },
      {
        ...
        wrongFeedback:
          'Close, but they did not run or sing. After marching, Joshua said "Shout!" and they shouted loud — that is when the walls came down (Joshua 6:20). (Answer: Shouted loudly.)'
      },
      {
        ...
        wrongFeedback:
          'The trumpets and shouting were part of the plan, but they were not magic. The real reason is that God made the walls fall when His people obeyed Him. (Answer: Because God made it happen.)'
      },
      {
        ...
        wrongFeedback:
          'Almost! The story shows that victory came from obedience, not just noise or time passing. Trust and obey God — that is the lesson! (Answer: Obeying God brings victory.)'
      }
    ],
      ...
      questions: [
        {
          ...
          choices: ['Rowing the boat', 'Sleeping', 'Calling down fire', 'Teaching a long lesson'],
          correctIndex: 1,
          correctFeedback: 'Yes! Jesus was asleep in the boat when the storm roared.',
          wrongFeedback:
            'Reread paragraph one. Where was Jesus before the disciples woke Him? (Answer: Sleeping.)'
        },
        {
          ...
          wrongFeedback:
            'Look at paragraph three. What did they say to Jesus in the KJV words? They were afraid of drowning. (Answer: They feared the boat would sink and they would drown.)'
        },
        {
          question: 'What did Jesus say to the wind and the waves?',
          choices: ['Row harder!', 'Peace, be still', 'Swim to shore!', 'Hide in the hull'],
          correctIndex: 1,
          correctFeedback: 'Exactly—that is what Mark 4:39 records in the King James Bible.',
          wrongFeedback:
            'Find the short command in paragraph four, right before the sea goes calm. (Answer: Peace, be still.)'
        },
        {
          ...
          wrongFeedback:
            'Picture paragraph four after "Peace, be still." Did it stay wild or become quiet? (Answer: The wind stopped and there was a great calm.)'
        },
        {
          ...
          wrongFeedback:
            'Think: who hushed the storm, and what did Jesus ask about fear and faith? Reread the last paragraph. (Answer: Jesus has power over everything—even storms—and we can trust Him.)'
        }
      ],
      ...
      questions: [
        {
          ...
          choices: ['Chance and time alone', 'God', 'Only angels', 'People in factories'],
          correctIndex: 1,
          correctFeedback: 'Yes—Genesis 1:1 starts with God the Creator.',
          wrongFeedback:
            'Look at the very first Bible verse quoted in paragraph one. Who creates? (Answer: God.)'
        },
        {
          question: 'What did God say to bring light at the start?',
          choices: ['Let there be light', 'Turn on the lamps', 'Wait for the sun', 'Light is not important'],
          correctIndex: 0,
          correctFeedback: 'Right—that is Genesis 1:3 in the KJV.',
          wrongFeedback:
            'Find the quoted words in paragraph two right after the dark beginning. (Answer: Let there be light.)'
        },
        {
          question: 'How does the story describe God\'s view of what He made?',
          choices: ['It was a mistake', 'It was boring', 'It was very good', 'He changed His mind'],
          correctIndex: 2,
          correctFeedback: 'Exactly—God delights in His creation.',
          wrongFeedback:
            'Read paragraph three near the end. What two words describe everything? (Answer: It was very good.)'
        },
        {
          ...
          wrongFeedback:
            'Skim paragraph four. Did God keep building, or stop to bless a day of rest? (Answer: Rested and blessed the day as holy.)'
        },
        {
          ...
          wrongFeedback:
            'Reread the last paragraph. Does it say you are an accident, or loved on purpose? (Answer: The same God who made the world knows me—and I can thank Him.)'
        }
      ],
      doneHeading: 'You Did It!',
