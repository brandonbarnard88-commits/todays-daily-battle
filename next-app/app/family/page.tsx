...
export default function FamilyPage() {
  const url = `${getMainSiteOrigin()}/kids/corner.html`;
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-4 pb-24 pt-10 sm:px-6 sm:pt-12">
        <Card className="border-border/70 shadow-none ring-1 ring-border/80">
          <CardHeader>
            <CardTitle className="font-heading text-2xl">Family &amp; kids</CardTitle>
            <p className="text-sm leading-relaxed text-muted-foreground">
              Low-pressure rhythms and printables — you&apos;re not behind. The full family corner
              lives on the main site until we migrate it here.
            </p>
          </CardHeader>
