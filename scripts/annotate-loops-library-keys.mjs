 ...
 * to rows in kids/bible-story-tool-index.js (304 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 304) {
    console.warn('warn: expected 304 index rows, got', rows.length);
  }
