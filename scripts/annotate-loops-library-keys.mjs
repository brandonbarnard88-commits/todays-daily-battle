 ...
 * to rows in kids/bible-story-tool-index.js (310 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 310) {
    console.warn('warn: expected 310 index rows, got', rows.length);
  }
