 ...
 * to rows in kids/bible-story-tool-index.js (308 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 308) {
    console.warn('warn: expected 308 index rows, got', rows.length);
  }
