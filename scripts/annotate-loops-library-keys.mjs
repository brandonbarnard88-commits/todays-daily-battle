 ...
 * to rows in kids/bible-story-tool-index.js (303 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 303) {
    console.warn('warn: expected 303 index rows, got', rows.length);
  }
