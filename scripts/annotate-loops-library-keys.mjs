 ...
 * to rows in kids/bible-story-tool-index.js (301 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 301) {
    console.warn('warn: expected 301 index rows, got', rows.length);
  }
