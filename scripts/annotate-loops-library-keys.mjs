 ...
 * to rows in kids/bible-story-tool-index.js (302 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 302) {
    console.warn('warn: expected 302 index rows, got', rows.length);
  }
