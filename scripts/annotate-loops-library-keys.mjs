 ...
 * to rows in kids/bible-story-tool-index.js (309 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 309) {
    console.warn('warn: expected 309 index rows, got', rows.length);
  }
