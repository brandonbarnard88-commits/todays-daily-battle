 ...
 * to rows in kids/bible-story-tool-index.js (307 Bible Story Library keys; keys match bibleStories).
 *
...
function main() {
  ...
  if (rows.length !== 307) {
    console.warn('warn: expected 307 index rows, got', rows.length);
  }
