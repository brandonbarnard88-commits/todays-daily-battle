...
${items}
  ...
  return `    <section class="glass tdb-porch-paper-glass tdb-ll-growing-note" aria-labelledby="tdb-ll-growing-heading">
      ...
      <p class="section-note util-mt-0">Sermon teachings, Cast Your Care, Be Anxious for Nothing, Psalm 23, Forgive Seventy Times Seven, Render Unto Caesar (authority &amp; conscience), <a href="/life-lessons/peace-in-the-storm-when-waves-are-louder.html">Peace in the Storm</a>, and <a href="/life-lessons/come-unto-me-when-weary-heavy-laden.html">Come Unto Me</a>\u2014each with anchor <abbr title="King James Version">KJV</abbr>, battles, cross-references, My Study save, and a print sheet. <a href="/lessons-from-the-valley.html">Lessons from the Valley</a> &middot; <a href="/mobius.html#mobius-ribbon-stations">Grace Ribbon stations</a> &middot; <a href="/porch-pathways-ribbon-one-page-print.html">Find Your Path map (print)</a> &middot; <a href="/mystudy.html#mystudy-ribbon-journal">Ribbon journal</a> &middot; <a href="/plans.html?plan=authorityconscience">Authority and Conscience</a> &middot; <a href="/plans.html?plan=comeuntome">Come Unto Me plan</a>. More may arrive one room at a time; no schedule, no pressure. <a href="/sermon-on-the-mount-twelve-one-page-print.html">Family overview printable</a> &middot; <a href="/plans.html?plan=beatitudes">Sermon plan</a>.</p>
    </section>`;
}
