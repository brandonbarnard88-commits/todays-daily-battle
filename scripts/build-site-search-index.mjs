...
const ENTRIES = [
  ...
  { t: 'Life Lessons from the Word', u: '/life-lessons.html', k: 'life lessons family kids adults scripture worry anxiety forgiveness waiting anger contentment lesson learned apply prepare heart quiet reflection print kjv bible study porch tool' },
