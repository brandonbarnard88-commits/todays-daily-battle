...
const ENTRIES = [
  ...
  { t: 'The University of Anxiety & Fear (7 days)', u: '/plans.html?plan=universityanxiety', k: 'anxiety fear worry panic what-if cast care' },
  ...
  { t: 'The University of Depression & Hopelessness (7 days)', u: '/plans.html?plan=heavyhope', k: 'depression heavy fog hope psalm hopelessness' },
