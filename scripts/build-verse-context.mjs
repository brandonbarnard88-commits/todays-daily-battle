...
const CHAPTER_OVERRIDES = {
  ...
  'Luke:12': { about: 'Jesus (through Luke)', to: 'Disciples tempted to fear and to store up treasure', setting: 'Jesus tells the rich fool parable and says, Fear not, little flock — do not be anxious; your Father knows your need.' },
  ...
  'John:8': { about: 'Jesus (through John)', to: 'Those in the temple hearing His claim', setting: 'Jesus speaks in the temple: I am the light of the world; He tells the truth that sets people free.' },
