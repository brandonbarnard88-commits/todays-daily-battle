...
export const STORY_HTML_MARKERS = [
  ...
  'loop-library-coloring.js?v=20260420elishapoisonstew',
  'kids-corner.js?v=20260420elishapoisonstew',
  'kids-page-sky.css?v=20260326playful',
  'uFuzzy.iife.min.js',
  'kids-verses-365.js?v=20260325kidsmeans',
  'kids-battle.js?v=20260420elishapoisonstew',
  'kids-read-quiz-data.js?v=20260420elishapoisonstew',
  'TDB_PANEL_RASTER',
  'nunito-latin.woff2',
