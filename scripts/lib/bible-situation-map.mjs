...
export const BOOK_CHAPTER_SITUATIONS = {
  ...
  Mark: [
    ...
    { from: 6, thru: 6, situation: 'Jesus is rejected at Nazareth; John is killed; He feeds the five thousand and walks on the sea.', about: 'Jesus (through Mark)', to: 'Crowds and disciples learning who He is' },
  ...
  Luke: [
    ...
    { from: 19, thru: 19, situation: 'Zacchaeus is found in Jericho; the Son of man is come to seek and to save that which was lost, then He draws near to Jerusalem.', about: 'Jesus (through Luke)', to: 'The lost whom the Son of man came to seek' },
