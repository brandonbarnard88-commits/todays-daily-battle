...
export const BOOK_CHAPTER_SITUATIONS = {
  ...
  Psalm: [
    ...
    { from: 102, thru: 102, situation: 'An afflicted cry that becomes hope: the psalmist pours out his trouble, then trusts God will arise and build Zion.', about: 'An afflicted psalmist — a prayer of the overwhelmed (untitled in the KJV)', to: 'The destitute who still pray — and you when you have nothing to bargain with' },
    { from: 103, thru: 103, situation: 'A Psalm of David: he commands his own soul to bless the Lord, then names the Lord’s benefits — mercy, forgiveness, and a father’s pity.', about: 'David', to: 'His own soul — and every soul that still needs to bless His holy name' },
  ...
  Isaiah: [
    ...
    { from: 41, thru: 41, situation: 'The Lord names Israel His servant and says Fear thou not; He holds their right hand and hears the poor who seek water.', about: 'Isaiah (the Lord speaking)', to: 'Israel in exile whom He will not forsake' },
