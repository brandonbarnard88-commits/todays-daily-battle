...
export const BOOK_CHAPTER_SITUATIONS = {
  ...
  Psalm: [
    ...
    { from: 93, thru: 97, situation: 'The Lord reigns: floods, thrones, and idols cannot unseat Him; joy for the upright.', about: 'A psalm writer', to: 'Anyone who needs to know God still reigns' },
  ...
  Matthew: [
    ...
    { from: 14, thru: 18, situation: 'John is killed; Jesus feeds multitudes, walks on water, and predicts the cross; the church is confessed.', about: 'Jesus (through Matthew)', to: 'Disciples learning who He is' },
