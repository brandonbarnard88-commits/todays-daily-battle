...
export const BOOK_CHAPTER_SITUATIONS = {
  ...
  Psalm: [
    ...
    { from: 102, thru: 102, situation: 'An afflicted cry that becomes hope: the psalmist pours out his trouble, then trusts God will arise and build Zion.', about: 'An afflicted psalmist — a prayer of the overwhelmed (untitled in the KJV)', to: 'Anyone whose days are like a shadow' },
