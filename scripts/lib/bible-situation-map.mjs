...
export const BOOK_CHAPTER_SITUATIONS = {
  ...
  Psalm: [
    { from: 1, thru: 2, situation: 'Opening of the Psalter: two ways (righteous and wicked) and the nations raging against the Lord’s anointed.', about: 'David or another psalm writer', to: 'Worshipers choosing the path of the righteous' },
    ...
    { from: 44, thru: 49, situation: 'National lament, a royal wedding song, God as refuge in trouble, and the vanity of trusting riches.', about: 'Sons of Korah or another psalm writer', to: 'Worshipers in joy and national distress' },
    ...
    { from: 69, thru: 72, situation: 'Deep waters of reproach; aging faith; Book II closes with Solomon’s royal prayer and “Amen.”', about: 'David or Solomon', to: 'The reproached and those praying for a just king' },
    ...
    { from: 84, thru: 89, situation: 'Longing for God’s courts; mercy and truth meet; Ethan wrestles with the seeming failure of David’s line.', about: 'Sons of Korah, David, or Ethan', to: 'Pilgrims and those clinging to God’s promise' },
    { from: 90, thru: 91, situation: 'Moses numbers our short days; a hymn of refuge under the shadow of the Almighty.', about: 'Moses or another psalm writer', to: 'A people numbering their days and needing shelter' },
    { from: 92, thru: 92, situation: 'A Sabbath song of thanksgiving: the psalmist praises the Lord because His works make the heart glad and the righteous still flourish in old age.', about: 'A psalm writer of thanksgiving', to: 'Worshipers giving thanks for God’s works' },
    { from: 93, thru: 93, situation: 'The Lord reigns: floods and noise cannot unseat Him; He is robed in majesty forever.', about: 'A psalm writer', to: 'Anyone who needs to know God still reigns' },
    /* Psalm 94 is not a “Lord reigns” enthronement hymn — it is a cry against injustice, then mercy when the foot slips. */
    { from: 94, thru: 94, situation: 'A cry against unjust thrones: the psalmist names oppression, then testifies that when his foot slipped, the Lord’s mercy held him up.', about: 'A psalm writer (unattributed)', to: 'Anyone whose footing feels uncertain under pressure' },
    { from: 95, thru: 97, situation: 'Worship the Lord as King: soft hearts, idol-smashing glory, and joy for the upright.', about: 'A psalm writer', to: 'Anyone who needs to know God still reigns' },
    { from: 98, thru: 100, situation: 'A new song for all the earth; holy worship; enter His gates with thanksgiving.', about: 'A psalm writer', to: 'All lands called to joyful worship' },
    ...
    { from: 104, thru: 106, situation: 'Creation praise; retelling of God’s faithfulness and Israel’s failures; Book IV ends in “Hallelujah.”', about: 'A psalm writer', to: 'A people remembering creation and covenant' },
    { from: 107, thru: 107, situation: 'Book V opens: the redeemed from trouble give thanks — desert, prison, sickness, and storm.', about: 'A psalm writer of thanksgiving', to: 'The redeemed telling what God has done' },
    ...
    { from: 111, thru: 118, situation: 'Hallelujah psalms: fear of the Lord, the righteous lifted, idols mocked, and “His mercy endures forever.”', about: 'A psalm writer', to: 'All who praise the Lord' },
    { from: 119, thru: 119, situation: 'The great acrostic love-song to God’s Word — law, precepts, and path for life.', about: 'A psalm writer devoted to God’s Word', to: 'Anyone learning to walk by Scripture' },
    { from: 120, thru: 134, situation: 'Songs of Ascents: pilgrims going up to Jerusalem sing of help, peace, and blessing.', about: 'A song of ascents writer', to: 'Travelers and worshipers going up to God’s house' },
    { from: 135, thru: 137, situation: 'Praise for the living God versus idols; by the rivers of Babylon, exiles weep for Zion.', about: 'A psalm writer', to: 'Exiles and all who refuse false gods' },
    ...
    { from: 146, thru: 150, situation: 'Final Hallelujah chorus: trust not in princes; everything that has breath praise the Lord.', about: 'A psalm writer', to: 'All creation called to praise' }
  ],
  Proverbs: [
