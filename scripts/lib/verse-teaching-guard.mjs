...
export const PHRASE_LOCKS = [
  ...
  { id: 'ps103-east-west-on-opening', re: /forgives all iniquity, heals, and removes transgressions as far as the east is from the west/i, allow: null },
  { id: 'ps103-benefits-lump', re: /forgives iniquity, heals diseases, redeems from destruction/i, allow: null },
  { id: 'ps103-redeem-on-wrong', re: /redeem(?:s|eth)?(?: (?:thy|your|the) life)? from destruction/i, allow: /^Psalm(s)?\s+103:4\b/i },
  { id: 'ps103-satisfy-on-wrong', re: /satisf(?:y|ies|ieth)(?: (?:thy|your) mouth)? with good things/i, allow: /^Psalm(s)?\s+103:5\b/i },
