/**
 * Deep Life Lesson: Come Unto Me (Matthew 11:28-30).
 */

/** @type {import('./life-lessons-types').LifeLessonDeep} */
export const COME_UNTO_ME_LESSON = {
  slug: 'come-unto-me-when-weary-heavy-laden',
  deep: true,
  deepSeries: 'Gospels for hard days',
  ...
  topics: ['exhaustion', 'grief', 'burnout', 'parenting', 'anxiety', 'trust', 'hope'],
  families: true,
  grownups: true,
  ...
  battles: [
    {
      title: 'Weariness after a heavy season',
      body:
    ...
    {
      title: 'Parenting with nothing left',
      body:
    ...
    {
      title: 'Grief that will not hurry',
      body:
  ...
  crossRefs: [
    { ref: 'Matthew 11:28-30', text: 'Come unto me, all ye that labour and are heavy laden, and I will give you rest… For my yoke is easy, and my burden is light.' },
    ...
    { ref: 'Mark 4:39', text: 'Peace, be still. And the wind ceased, and there was a great calm.' },
    { ref: 'Hebrews 4:9-10', text: 'There remaineth therefore a rest to the people of God… For he that is entered into his rest, he also hath ceased from his own works.' },
  ],
  smallStep:
  ...
  littleOnes:
    'When you feel tired, Jesus says come\u2014like a child climbing into a safe lap. Read <a href="/kids/porch-read-come-unto-me.html">Come Unto Me read-aloud</a> at bedtime. Color a simple pillow and boat while you whisper the verse.',
  porch: [
    { label: 'Come Unto Me (5-day plan)', href: '/plans.html?plan=comeuntome' },
    { label: 'When Words Fail (Life Lesson)', href: '/life-lessons/when-words-fail.html' },
