/**
 * Deep Life Lesson: Peace in the Storm (Mark 4:35-41).
 */

/** @type {import('./life-lessons-types').LifeLessonDeep} */
export const PEACE_IN_THE_STORM_LESSON = {
  ...
  topics: ['fear', 'anxiety', 'grief', 'parenting', 'exhaustion', 'trust', 'family', 'trauma'],
  families: true,
  grownups: true,
  ...
  battles: [
    ...
    {
      title: 'Marriage or family strain',
      body:
  ...
  crossRefs: [
    ...
    { ref: 'Matthew 8:23-27', text: 'And he arose, and rebuked the winds and the sea; and there was a great calm.' },
  ...
  littleOnes:
    'Tell your children: Jesus was in a real boat with real wind and real waves. He is with us in every hard thing too. You can whisper \u201cPeace, be still\u201d when you feel scared. Pair with <a href="/kids/porch-read-peace-in-storm.html">Peace in the storm read-aloud</a> and <a href="/life-lessons/house-on-rock-when-storms-hit.html">House on the Rock</a>.',
  porch: [
    { label: 'Come Unto Me (deep lesson)', href: '/life-lessons/come-unto-me-when-weary-heavy-laden.html' },
