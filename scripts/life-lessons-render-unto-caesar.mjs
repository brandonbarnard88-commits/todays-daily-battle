/**
 * Deep Life Lesson: Render Unto Caesar (Matthew 22:21) — authority & conscience.
 */

/** @type {import('./life-lessons-types').LifeLessonDeep} */
export const RENDER_UNTO_CAESAR_LESSON = {
  slug: 'render-unto-caesar-when-laws-pull-apart',
  deep: true,
  deepSeries: 'Authority & conscience',
  ...
  unfolding: [
    ...
    'Authority is ordained of God in Romans 13, yet never absolute. Rulers are servants under the King of kings. When they command what God forbids or forbid what God commands, the line is clear\u2014and costly. The cross proves earthly power cannot have the final word.',
  ...
  battles: [
    {
      title: 'Parenting and family decisions',
      body:
    ...
    {
      title: 'Work, taxes, and \u201clegal but not right\u201d',
      body:
    ...
    {
      title: 'Speaking truth when it costs',
      body:
    ...
    {
      title: 'Anxiety when laws feel heavy or unjust',
      body:
    ...
    {
      title: 'Raising children who discern legal vs. right',
      body:
  ...
  crossRefs: [
    ...
    {
      ref: 'Acts 4:19-20',
      text: 'But Peter and John answered and said unto them, Whether it be right in the sight of God to hearken unto you more than unto God, judge ye. For we cannot but speak the things which we have seen and heard.',
    },
    {
      ref: '1 Peter 2:13-17',
      text: 'Submit yourselves to every ordinance of man for the Lord\u2019s sake: whether it be to the king, as supreme; Or unto governors, as unto them that are sent by him for the punishment of evildoers, and for the praise of them that do well. For so is the will of God, that with well doing ye may put to silence the ignorance of foolish men: As free, and not using your liberty for a cloke of maliciousness, but as the servants of God. Honour all men. Love the brotherhood. Fear God. Honour the king.',
    },
    {
      ref: 'Exodus 1:17',
    ...
    {
      ref: 'Daniel 3:17-18',
      text: 'If it be so, our God whom we serve is able to deliver us from the burning fiery furnace, and he will deliver us out of thine hand, O king. But if not, be it known unto thee, O king, that we will not serve thy gods, nor worship the golden image which thou hast set up.',
    },
  ],
  smallStep:
  ...
  littleOnes:
    'Show a coin (or a picture of one). Talk about whose picture is on it and whose image we bear (Genesis 1:27). We follow rules that keep people safe; we always obey God first. Little Shepherd read-alouds: <a href="/kids/porch-read-render-unto-caesar.html">God first</a> &middot; <a href="/kids/porch-read-good-shepherd.html">The Lord is my shepherd</a>. Pair with <a href="/life-lessons/house-on-rock-when-storms-hit.html">House on the Rock</a> when storms feel confusing.',
  porch: [
    { label: 'Authority and Conscience (6-day plan)', href: '/plans.html?plan=authorityconscience' },
    { label: 'Love Your Enemies (deep lesson)', href: '/life-lessons/love-your-enemies-when-love-costs.html' },
    { label: 'House on the Rock (deep lesson)', href: '/life-lessons/house-on-rock-when-storms-hit.html' },
    { label: 'Be Anxious for Nothing (deep lesson)', href: '/life-lessons/anxious-for-nothing-peace-of-god.html' },
    { label: 'Salt and Light (deep lesson)', href: '/life-lessons/salt-and-light-when-you-feel-small.html' },
    { label: 'Walk in Honesty', href: '/life-lessons/walk-in-honesty.html' },
    { label: 'Sermon on the Mount plan', href: '/plans.html?plan=beatitudes' },
    { label: 'My Study', href: '/mystudy.html' },
    { label: 'God\u2019s University of Life', href: '/gods-university-of-life.html' },
  ],
};
