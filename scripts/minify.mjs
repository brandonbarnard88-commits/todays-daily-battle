...
const JS_FILES = ['script.js', 'easter-eggs.js', 'easter-season.js', 'plans-data.js', 'seasonal-tracks-data.js', 'memory-verses.js', 'mission-outreach-data.js'];
const CSS_FILES = ['styles.css', 'tdb-quiet-luxury.css', 'tdb-calm-hubs.css', 'tool-pages.css', 'church.css', 'loop-player.css', 'kids-corner.css', 'mystudy.css', 'what-god-has-done.css', 'kids/story-library-fonts.css'];
