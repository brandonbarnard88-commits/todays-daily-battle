...
const AUX_BASENAME =
  /(cormorant-latin-subset|what-god-has-done|mystudy|church|pastor|bible-hub|bible-tools|bible-study|loop-player|kids-battle|kids-hub-play|kids-kids-world|kids-play-skin|kids-page-sky|tdb-porch-sky|kids-corner|kids-story-remember|color-and-tell|story-library-fonts|canvas|tdb-opal-tokens)\.css(?:\?|$)/;
