...
const AUX_BASENAME =
  /(cormorant-latin-subset|what-god-has-done|mystudy|church|pastor|bible-hub|bible-tools|bible-study|loop-player|kids-battle|kids-play-zone|kids-kids-world|kids-page-sky|kids-corner|color-and-tell|story-library-fonts|canvas)\.css(?:\?|$)/;
