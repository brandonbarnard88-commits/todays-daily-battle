...
const pages = [
  ...
  { path: '/for-pastors.html', name: 'For pastors', mustInclude: ['For pastors', 'mobile ministers', 'verse-cards', 'sermon.html', 'explore.html#languages', 'plans.html', 'data-tdb-lang-switcher', 'tdb-cache-hygiene:'] },
