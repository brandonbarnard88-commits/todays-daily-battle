...
const pages = [
  ...
  { path: '/memorize.html', name: 'Memorize', mustInclude: ['Memorize', 'memorize.js', 'One-tap verse cards', 'Gentle review', 'Nothing here yet', 'mem-queue-empty', 'bible-study-companion.js', 'Typing practice'] },
