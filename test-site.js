...
const pages = [
  ...
  { path: '/verse.html', name: 'Verse of the Day', mustInclude: ['Verse', 'verse-save-hint', 'verse-page-save-my-verses', 'verse-listen-hint', 'verse-listen-btn', 'KJV loads on this device', 'My Verses', '/bible-tool.html', 'Share with someone who needs it', 'verse-page-share-encourage', 'verse-prayer-wall-nudge', 'message.html#message-board', 'tdb-cache-hygiene:'] },
