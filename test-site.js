...
const pages = [
  ...
  { path: '/id/kecemasan.html', name: 'Topic Kecemasan (ID)', mustInclude: ['lang="id"', 'Kecemasan', 'KJV', 'Psalm 55:22', 'topic-anxiety.html', 'ansiedad.html', 'tl/kabalisahan.html', 'ar/qalaq.html', 'id-mas-ayuda', 'Mulai di sini', 'Napas singkat', 'id-start-here', 'id-why-kjv', 'Mengapa KJV', 'id-my-verses-guide', 'Jika Anda membuka Calm', 'tdb-lang-switcher-eyebrow', '>Bahasa</span>'] },
  { path: '/tl/kabalisahan.html', name: 'Topic Kabalisahan (TL)', mustInclude: ['lang="tl"', 'Kabalisahan', 'KJV', 'Psalm 55:22', 'topic-anxiety.html', 'ansiedad.html', 'id/kecemasan.html', 'ar/qalaq.html', 'tl-mas-tulong', 'Simula dito', 'tl-start-here', 'tl-why-kjv', 'Bakit KJV', 'tl-my-verses-guide', 'Kung bubuksan mo ang Calm', 'data-tdb-pick="tl"', '>Wika</span>'] },
  { path: '/fr/anxiete.html', name: 'Topic Anxiété (FR)', mustInclude: ['lang="fr"', 'anxiété', 'Louis Segond', 'Psaumes 55:22', 'topic-anxiety.html', 'zh/jiaolv.html', 'ar/qalaq.html', 'fr-mas-ayuda', 'data-tdb-pick="fr"', 'hreflang="zh-CN"'] },
  { path: '/zh/jiaolv.html', name: 'Topic 焦虑 (ZH)', mustInclude: ['lang="zh-CN"', '焦虑', '和合本', '诗篇', 'topic-anxiety.html', 'fr/anxiete.html', 'ar/qalaq.html', 'zh-mas-ayuda', 'data-tdb-pick="zh"', 'zh-pilot-body'] },
  { path: '/ar/qalaq.html', name: 'Topic قلق (AR)', mustInclude: ['lang="ar"', 'dir="rtl"', 'ar-pilot-body', 'فان دايك', 'المزمور', 'topic-anxiety.html', 'ar-mas-ayuda', 'data-tdb-pick="ar"', 'عندما يخنقك القلق', 'site-footer-pilot-note'] },
