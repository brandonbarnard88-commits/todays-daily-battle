...
const pages = [
  ...
  { path: '/mobius.html', name: 'Möbius Loop', mustInclude: ['Möbius Loop', 'mobius-season-lead', 'One ribbon for every season', 'id="mobius-loop-journal"', 'mobius-deep-journal-input', 'mobius-deep-journal-export', 'mobius-v2-journal-input', 'tdb-mobius-journal', 'what-god-has-done.html', 'KJV only', 'mobius-text-v2.js'] },
