...
const pages = [
  ...
  { path: '/privacy.html', name: 'Privacy', mustInclude: ['Privacy', 'terms.html', 'Privacy is simple here', 'Friday email list'] },
  ...
  { path: '/explore.html', name: 'Explore', mustInclude: ['Explore the site', 'explore-hub-grid', 'id="explore-hub"', 'explore-link-list', 'topic-anxiety.html', 'verse-image.html', 'id="topics-es">Spanish topics', 'Spanish devotionals', '>Spanish topics</a>', 'id="languages"', 'for-pastors.html', 'Kecemasan', 'Kabalisahan', 'tl/kabalisahan.html', 'fr/anxiete.html', 'zh/jiaolv.html', 'ar/qalaq.html', 'hi/chinta.html', 'ru/trevoga.html', 'sv/oro.html', 'Português — início', 'href="/pt/"', 'pt/ansiedade.html', 'bn/chinta.html', 'sw/wasiwasi.html', 'Synodal', '1917', 'Almeida', 'Calcutta', 'Kiswahili', 'Van Dyck', '1851 Hindi', 'fr/espoir.html', 'zh/xiwang.html', 'ru/nadezhda.html', 'pt/esperanca.html', 'tl/pagasa.html', 'id/harapan.html', 'fr/solitude.html', 'zh/gudu.html', 'fr/culpabilite.html', 'zh/neijiu.html', 'fr/deborde.html', 'zh/taiduo.html', 'Louis Segond', 'Reina-Valera 1960', 'data-tdb-pick="tl"', 'data-tdb-pick="ar"', 'data-tdb-pick="hi"', 'data-tdb-pick="ru"', 'data-tdb-pick="sv"', 'data-tdb-pick="pt"', 'data-tdb-pick="bn"', 'data-tdb-pick="sw"', 'tdb-lang-switcher-eyebrow', 'tdb-cache-hygiene:'] },
  ...
  { path: '/plans.html', name: 'Battle Plans', mustInclude: ['Battle Plans', 'plan-list', 'planIndex', 'tdb-cache-hygiene:'] },
  ...
  { path: '/topic-loneliness.html', name: 'Topic Loneliness', mustInclude: ['Feel Alone', 'hreflang="fr" href="https://todaysdailybattle.com/fr/solitude.html"', 'hreflang="zh-CN" href="https://todaysdailybattle.com/zh/gudu.html"', 'fr/solitude.html', 'zh/gudu.html'] },
  { path: '/topic-guilt.html', name: 'Topic Guilt', mustInclude: ['Guilt', 'hreflang="fr" href="https://todaysdailybattle.com/fr/culpabilite.html"', 'hreflang="zh-CN" href="https://todaysdailybattle.com/zh/neijiu.html"', 'fr/culpabilite.html', 'zh/neijiu.html'] },
  { path: '/topic-overwhelmed.html', name: 'Topic Overwhelmed', mustInclude: ['Overwhelmed', 'hreflang="fr" href="https://todaysdailybattle.com/fr/deborde.html"', 'hreflang="zh-CN" href="https://todaysdailybattle.com/zh/taiduo.html"', 'fr/deborde.html', 'zh/taiduo.html'] },
  ...
  { path: '/topic-fear.html', name: 'Topic Fear', mustInclude: ['Fear', 'Courage', 'Key Verses', 'rel="canonical" href="https://todaysdailybattle.com/topic-fear.html"', 'data-tdb-lang-switcher', 'Related Topics'] },
  ...
  { path: '/fuerza.html', name: 'Topic Fuerza (ES)', mustInclude: ['Fuerza', 'hreflang="x-default"', 'rel="canonical" href="https://todaysdailybattle.com/fuerza.html"', 'Fuerza en Cristo: versículos (Reina-Valera 1960', 'Anxiety (ES)', 'Strength (ES)', 'Peace (ES)'] },
  { path: '/paz.html', name: 'Topic Paz (ES)', mustInclude: ['Paz', 'hreflang="x-default"', 'rel="canonical" href="https://todaysdailybattle.com/paz.html"', 'Paz de Dios: versículos (Reina-Valera 1960', 'Anxiety (ES)', 'Strength (ES)', 'Peace (ES)'] },
  ...
  { path: '/pt/index.html', name: 'Portuguese hub', mustInclude: ['lang="pt"', 'pt-hub-hero', 'Versículo do dia', 'href="/verse.html"', 'pt/ansiedade.html', 'pt/esperanca.html', 'data-tdb-pick="pt"', 'hreflang="pt" href="https://todaysdailybattle.com/pt/"', 'Salmos 55:22', 'Almeida', 'interface em inglês'] },
  ...
  { path: '/zh/neijiu.html', name: 'Topic 内疚 (ZH)', mustInclude: ['lang="zh-CN"', '内疚', '和合本', '约翰一书', 'topic-guilt.html', 'fr/culpabilite.html', 'zh-topic-breakdown', 'data-tdb-pick="zh"', 'zh-pilot-body'] },
  { path: '/fr/deborde.html', name: 'Topic Débordé (FR)', mustInclude: ['lang="fr"', 'débordé', 'Louis Segond', 'Matthieu 11:28', 'topic-overwhelmed.html', 'zh/taiduo.html', 'fr-topic-breakdown', 'data-tdb-pick="fr"'] },
  { path: '/zh/taiduo.html', name: 'Topic 太多 (ZH)', mustInclude: ['lang="zh-CN"', '太多', '和合本', '马太福音', 'topic-overwhelmed.html', 'fr/deborde.html', 'zh-topic-breakdown', 'data-tdb-pick="zh"', 'zh-pilot-body'] },
