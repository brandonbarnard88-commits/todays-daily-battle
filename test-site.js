...
const pages = [
  ...
  { path: '/kids-corner.html', name: 'Kids Corner', mustInclude: ['Bible Loop', 'Story Stars', 'loop-grid', 'kids-loop-og.jpg', 'summary_large_image', 'Download loop progress (PDF)', 'loop-pdf-export', 'aria-describedby="loop-pdf-export-count-hint loop-pdf-export-hint"', 'script.js?v=20260326clean', 'kids-corner.css?v=7'] },
  { path: '/kids/index.html', name: 'Kids Battle Home', mustInclude: ['Kids Battle', 'Library deep links must hit corner.html', "location.replace('corner.html' + location.search)", 'Read-along words, comic panels', 'kids-battle.js?v=20260330kidslib', 'kids-read-quiz-data.js?v=20260330kidslib', 'kids-corner.js?v=20260330kidslib', 'footer-humility', 'We battle. He wins.'] },
  { path: '/kids/corner.html', name: 'Bible Story Library', mustInclude: ['/kids/corner.html?story=noah', 'kids-story-library-og.jpg', 'summary_large_image', 'Download Story Library List (PDF)', 'pdf-export', 'aria-describedby="pdf-export-count-hint pdf-export-hint"', 'story-library-fonts.css?v=1', 'kids-library-search-hint', 'uFuzzy.iife.min.js', 'kids-corner.js?v=20260331kidsfuzzy', 'kids-battle.js?v=20260330kidslib', 'kids-read-quiz-data.js?v=20260330kidslib', 'hard-refresh', 'canvas-confetti', 'global-quiz-challenge', 'print-qa-btn', 'kids-print-qa-sheet-wrap', 'TDB_PANEL_RASTER', 'nunito-latin.woff2', 'panel-david-1.svg', 'Bible Story Library'] },
  { path: '/kids/all-stories.html', name: 'Kids All Stories A–Z', mustInclude: ['All Bible Stories', 'bible-story-tool-index.js', 'uFuzzy.iife.min.js', 'kids-all-stories.js?v=20260331kidsfuzzy', 'corner.html?story='] },
