...
const pages = [
  ...
  { path: '/kids/index.html', name: 'Kids Battle Home', mustInclude: ['Kids Battle', 'Library deep links must hit corner.html', "location.replace('corner.html' + location.search)", 'Read-along words, comic panels', 'Color &amp; create', 'coloring.html', 'uFuzzy.iife.min.js', 'kids-verses-365.js?v=20260325kidsmeans', 'kids-battle.js?v=20260325story', 'kids-read-quiz-data.js?v=20260330kidslib', 'kids-corner.js?v=20260331kidsnav', 'kids-page-sky.css?v=20260325calm', 'kids-page-sky.js?v=20260325calm', 'kids-hub-story-matches', 'kids-header-site-link-wrap', 'footer-humility', 'We battle. He wins.'] },
