...
const pages = [
  ...
  { path: '/pricing.html', name: 'Pricing', mustInclude: ['Pricing', 'Subscribe', 'terms.html', 'pricing-verse-preview-strip', 'Supporter verse cards'] },
  ...
  { path: '/mobius.html', name: 'Möbius Loop', mustInclude: ['Möbius Loop', 'mobius-season-lead', 'mobius-audio-roadmap', 'human-narrated', 'One ribbon for every season', 'id="mobius-loop-journal"', 'mobius-deep-journal-input', 'mobius-deep-journal-export', 'mobius-v2-journal-input', 'tdb-mobius-journal', 'what-god-has-done.html', 'KJV only', 'mobius-text-v2.js', 'mobius-guided-audio-human', 'mobius-guided-human.mp3', 'mobius-guided-voice-wrap'] },
