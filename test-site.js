...
const pages = [
  ...
  { path: '/coloring.html', name: 'Kids Coloring', mustInclude: ['Coloring', 'Kids', 'jl-coloringbook', 'tdb-cat-root', 'Watch My Story', 'color-and-tell.js', '/vendor/jl-coloringBook.js', '/coloring-pages/noah-s1.svg'] },
