...
const pages = [
  ...
  { path: '/pricing.html', name: 'Pricing', mustInclude: ['Pricing', 'Subscribe', 'terms.html', 'pricing-verse-preview-strip', 'Supporter verse cards', 'pricing-card-verse-thumbs', 'styles.css?v=20260431pricing'] },
  ...
  { path: '/my-verses.html', name: 'My Verses', mustInclude: ['My Verses', 'id="saved-verses"', 'id="my-verses-panel"', 'bible-tool.html', '/bible/tools.html', 'Study workshop', 'Study workspace', 'don&rsquo;t use your list for ads', 'footer-humility', 'We battle. He wins.', 'tdb-cache-hygiene:'] },
