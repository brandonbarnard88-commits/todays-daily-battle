...
const pages = [
  ...
  { path: '/sermon.html', name: 'Sermon', mustInclude: ['Sermon', 'sb-quick-preach-btn', 'The Peace That Guards', 'Philippians 4:6-7', 'sb-pdf-handout-btn', 'Handout PDF', 'Lesson pack', 'sb-oia-points', 'Main points (OIA)', 'For pastors &amp; teachers', 'sb-study-materials', 'Supporting context'] },
