...
const pages = [
  ...
  { path: '/verse.html', name: 'Verse of the Day', mustInclude: ['Verse', 'verse-save-hint', 'verse-page-save-my-verses', 'verse-listen-hint', 'verse-listen-btn', 'KJV on this device', 'My Verses', '/bible-tool.html', 'Share with someone who needs it', 'verse-page-share-encourage', 'tdb-cache-hygiene:'] },
  ...
  { path: '/memorize.html', name: 'Memorize', mustInclude: ['Memorize', 'memorize.js', 'One-tap verse cards', 'Gentle review', 'Nothing in your memory list yet', 'mem-queue-empty', 'bible-study-companion.js', 'Typing practice', 'tdb-offline-strip'] },
