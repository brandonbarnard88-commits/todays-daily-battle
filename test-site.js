...
const pages = [
  ...
  { path: '/verse.html', name: 'Verse of the Day', mustInclude: ['Verse', 'verse-save-hint', 'verse-page-save-my-verses', 'verse-page-memorize-link', 'verse-save-hint-memorize', 'verse-listen-hint', 'verse-listen-btn', 'KJV loads on this device', 'My Verses', '/bible-tool.html', 'Share with someone who needs it', 'verse-page-share-encourage', 'verse-prayer-wall-nudge', 'message.html#message-board', 'tdb-verse-ribbon-toggle', 'tdb-mobius-journal', 'mobius.html#mobius-loop-journal', 'tdb-cache-hygiene:'] },
  ...
  { path: '/message.html', name: 'Message / Prayer Wall', mustInclude: ['message', 'Prayer', 'Encouragement', 'message-prayer-quiet-feed-note', 'read and pray without posting', 'tdb-privacy-whisper', 'Before you post:', 'hreflang="pt" href="https://todaysdailybattle.com/pt/mural.html"'] },
