...
const pages = [
  ...
  { path: '/reader.html', name: 'Chapter Reader', mustInclude: ['Reader', 'Chapter', 'Saved chapters', 'Save chapter', 'reader-bookmark-toggle', 'Recently opened (this device)', 'reader-resume-strip', 'bible/tools.html#book-intros', 'hreflang="pt" href="https://todaysdailybattle.com/pt/leitor.html"'] },
  ...
  { path: '/what-god-has-done.html', name: 'What God has done', mustInclude: ['What God has done', 'Private; stays on this device', 'wghd-footer-privacy', 'what-god-has-done.js', 'Save entry', 'Clear all entries on this device', 'Download as JSON'] },
