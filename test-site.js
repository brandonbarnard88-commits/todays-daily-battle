...
const pages = [
  ...
  { path: '/explore.html', name: 'Explore', mustInclude: ['Explore the site', 'explore-hub-grid', 'id="explore-hub"', 'explore-link-list', 'topic-anxiety.html', 'verse-image.html', 'id="topics-es">Spanish topics', 'Spanish devotionals', '>Spanish topics</a>', 'id="languages"', 'Supported hubs', 'Additional languages', 'for-pastors.html', 'Kecemasan', 'Kabalisahan', 'tl/kabalisahan.html', 'href="/es/"', 'Español — inicio', 'href="/fr/"', 'fr/anxiete.html', 'href="/zh/"', '中文 — hub', 'href="/ru/"', 'Русский — hub', 'href="/hi/"', 'हिन्दी — hub', 'zh/jiaolv.html', 'ar/qalaq.html', 'hi/chinta.html', 'ru/trevoga.html', 'zh/kongju.html', 'hi/dar.html', 'ru/strakh.html', 'sv/oro.html', 'Português — início', 'href="/pt/"', 'pt/ansiedade.html', 'pt/medo.html', 'pt/planos.html', 'pt/privacy.html', 'bn/chinta.html', 'sw/wasiwasi.html', 'Synodal', '1917', 'Almeida', 'Calcutta', 'Kiswahili', 'Van Dyck', '1851 Hindi', 'fr/espoir.html', 'zh/xiwang.html', 'ru/nadezhda.html', 'pt/esperanca.html', 'tl/pagasa.html', 'id/harapan.html', 'id/ketakutan.html', 'fr/pardon.html', 'perdon.html', 'zh/heping.html', 'zh/kuanshu.html', 'ru/proshchenie.html', 'hi/kshama.html', 'fr/solitude.html', 'zh/gudu.html', 'fr/culpabilite.html', 'zh/neijiu.html', 'fr/deborde.html', 'zh/taiduo.html', 'Louis Segond', 'Reina-Valera 1960', 'data-tdb-pick="en"', 'data-tdb-pick="es"', 'data-tdb-pick="fr"', 'data-tdb-pick="pt"', 'tdb-lang-switcher-eyebrow', 'tdb-cache-hygiene:'] },
  ...
  { path: '/planes.html', name: 'ES shell Planes', mustInclude: ['lang="es"', 'Planes de lectura — pantalla en inglés', 'href="/plans.html"', 'data-tdb-pick="es"', 'site-footer-pilot-note', 'aria-label="Pie del sitio"', 'Compartir esta página'] },
