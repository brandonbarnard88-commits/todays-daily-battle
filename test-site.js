...
const pages = [
  ...
  { path: '/family-armor.html', name: 'Family Armor', mustInclude: ['Family Armor &amp; Stories', 'Ephesians 6', 'whole armour of God', 'Open the Family Armor workspace', '/#armor-builder-btn', 'kids/corner.html', 'family.html', 'curriculum.html', 'aria-current="page"', 'href="/family-armor.html"', 'family-armor-trust-strip', 'stays on this device'] },
  ...
  { path: '/reader.html', name: 'Chapter Reader', mustInclude: ['Reader', 'Chapter', 'bible/tools.html#book-intros', 'hreflang="pt" href="https://todaysdailybattle.com/pt/leitor.html"'] },
