...
const pages = [
  ...
  { path: '/what-god-has-done.html', name: 'What God has done', mustInclude: ['What God has done', 'Private; stays on this device', 'what-god-has-done.js', 'Save entry', 'Clear all entries on this device', 'Download as JSON'] },
