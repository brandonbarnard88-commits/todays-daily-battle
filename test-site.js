...
const pages = [
  ...
  { path: '/study.html', name: 'Study', mustInclude: ['Study', 'notes', 'bible/tools.html', 'Study workshop', 'mystudy.html'] },
  ...
  { path: '/reader.html', name: 'Chapter Reader', mustInclude: ['Reader', 'Chapter', 'Saved chapters', 'Save chapter', 'reader-bookmark-toggle', 'Recently opened (this device)', 'reader-resume-strip', 'reader-crossrefs-panel', 'reader-chapter-study-notes', 'Related verses', 'reader-xrefs-layer', 'reader-wordstudy-layer', 'memorize.html', 'bible/tools.html#book-intros', 'hreflang="pt" href="https://todaysdailybattle.com/pt/leitor.html"'] },
  ...
  { path: '/what-god-has-done.html', name: 'What God has done', mustInclude: ['What God has done', 'Private &mdash; everything stays on this device', 'Everything here stays completely on your device', 'wghd-footer-privacy', 'what-god-has-done.js', 'id="wghd-save"', 'Name what God has done today', 'wghd-export-details', 'what-god-has-done.js?v=', 'maxlength="800"', 'A few sentences is perfect', 'wghd-body-count-sr'] },
  { path: '/memorize.html', name: 'Memorize', mustInclude: ['Memorize', 'memorize.js', 'One-tap verse cards', 'Gentle review', 'Nothing in your memory list yet', 'mem-queue-empty', 'bible-study-companion.js', 'Typing practice'] },
