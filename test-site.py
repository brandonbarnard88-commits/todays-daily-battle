...
PAGES = [
    ...
    ("/bible-tool.html", "Bible Tool", ["Bible Tool", "Bible stories", "bible-story-tool-index.js", "Featured this week", "corner.html?story=davidGoliath", "id=\"lookup-btn\"", "id=\"daily-ref\"", "Read full chapter", "verse-image.html"]),
    ...
    ("/kids-corner.html", "Kids Corner", ["Bible Loop Library", "kids-loop-og.jpg", "Download loop progress (PDF)", "loop-pdf-export", 'aria-describedby="loop-pdf-export-count-hint loop-pdf-export-hint"', "Quick calm loops", "Open Kids Coloring", "coloring.html", "Story Stars", "loop-grid", "script.js?v=20260326clean", "kids-corner.css?v=7"]),
    ("/kids/index.html", "Kids Battle Home", ["Kids Battle", "Library deep links must hit corner.html", "location.replace('corner.html' + location.search)", "Read-along words, comic panels", "Color &amp; create", "coloring.html", "uFuzzy.iife.min.js", "kids-battle.js?v=20260323kidslib", "kids-read-quiz-data.js?v=20260330kidslib", "kids-corner.js?v=20260331kidsdeeplink", "kids-hub-story-matches", "footer-humility", "We battle. He wins."]),
    ("/kids/corner.html", "Bible Story Library", ["/kids/corner.html?story=noah", "kids-story-library-og.jpg", "Download Story Library List (PDF)", "Bible Story Library", 'aria-describedby="pdf-export-count-hint pdf-export-hint"', "story-library-fonts.css?v=1", "kids-library-search-hint", "uFuzzy.iife.min.js", "fuse.min.js", "kids-story-fuse-search.js", "kids-library-search-suggest", "kids-battle.js?v=20260323kidslib", "kids-read-quiz-data.js?v=20260330kidslib", "kids-corner.js?v=20260331kidsdeeplink", "hard-refresh", "canvas-confetti", "global-quiz-challenge", "print-qa-btn", "kids-print-qa-sheet-wrap", "TDB_PANEL_RASTER", "nunito-latin.woff2", "panel-david-1.svg", "tdb-kids-story-meta-desc"]),
    ("/kids/all-stories.html", "Kids All Stories A–Z", ["All Bible Stories", "bible-story-tool-index.js", "uFuzzy.iife.min.js", "fuse.min.js", "kids-story-fuse-search.js", "kids-all-stories.js?v=20260331kidsfuzzy", "corner.html?story=", "kids-all-fuse-suggest"]),
