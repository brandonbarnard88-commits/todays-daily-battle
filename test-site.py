...
PAGES = [
    ...
    ("/kids-corner.html", "Kids Corner", ["Bible Loop Library", "kids-loop-og.jpg", "Download loop progress (PDF)", "loop-pdf-export", "Story Stars", "loop-grid"]),
    ("/kids/corner.html", "Bible Story Library", ["kids-story-library-og.jpg", "Download Story Library List (PDF)", "Bible Story Library", "kids-corner.js?v=66"]),
