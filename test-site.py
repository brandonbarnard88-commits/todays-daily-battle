...
PAGES = [
    ...
    ("/bible-study.html", "Bible Study", ["Bible", "study-card-title", "Armor of God", "reading-plan.html?study=armor-of-god", "plans.html?plan=beatitudes", "plans.html?plan=peacemakers", "plans.html?plan=lordsprayer", "plans.html?plan=beatitudeskids", "script.js?v=20260328studyhydrate", "id=\"auth-section\""]),
