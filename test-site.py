...
PAGES = [
    ...
    ("/pricing.html", "Pricing", ["Pricing", "Subscribe", "terms.html", "pricing-verse-preview-strip", "Supporter verse cards", "pricing-card-verse-thumbs", "styles.css?v=20260431pricing", "id=\"auth-section\"", "id=\"sidebar-toggle\""]),
    ...
    ("/plans.html", "Battle Plans", ["Battle Plans", "plan-list", "planIndex", "plans-hero--soar-dawn", "plans-audio-roadmap", "human narration", "id=\"plans-lane-foundations\"", "plans-lane-quick", "href=\"#plans-lane-pain\"", "id=\"plans-lane-uncertainty\"", "id=\"plans-lane-fear\"", "id=\"plans-lane-family\"", "id=\"planFamilyIntro\"", "plan-family-intro", "familyworship", "Family Worship in the Trenches", "psalmscomfortfamily", "Psalms of Comfort (Family Edition)", "hreflang=\"pt\" href=\"https://todaysdailybattle.com/pt/planos.html\"", "tdb-mobius-journal", "Save to loop journal", "mobius.html#mobius-loop-journal", "tdb-cache-hygiene:"]),
