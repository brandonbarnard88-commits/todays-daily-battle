...
PAGES = [
    ...
    ("/verse-image.html", "Verse image generator", ["Verse image generator", "verse-image-canvas", "Supporter", "recent-gens", "data-verse-store", "verse-image-text-color", "verse-image-template", "Classic soar", "Peace &amp; hope", "Eagle flight", "cross", "value=\"soar\"", "dawn sky", "value=\"hush\"", "verse-image.js?v=20260402tpl12"]),
