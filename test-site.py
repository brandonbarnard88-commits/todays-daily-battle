...
PAGES = [
    ...
    ("/my-verses.html", "My Verses", ["My Verses", "my-verses-hero--soar-dawn", "id=\"my-verses-hero-heading\"", "id=\"saved-verses\"", "id=\"my-verses-panel\"", "bible-tool.html", "Study workspace", "styles.css?v=20260431myversplans", "don&rsquo;t use your list for ads", "footer-humility", "We battle. He wins.", "tdb-cache-hygiene:"]),
    ...
    ("/bible-tool.html", "Bible Tool", ["Bible Tool", "bible-tool-hero--soar-dawn", "Study workshop", "bible/tools.html", "Bible stories", "bible-story-tool-index.js", "Featured this week", "corner.html?story=davidGoliath", "id=\"lookup-btn\"", "id=\"daily-ref\"", "Read full chapter", "verse-image.html", "styles.css?v=20260431biblekidsdawn", "tdb-cache-hygiene:"]),
