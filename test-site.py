...
PAGES = [
    ...
    ("/pricing.html", "Pricing", ["Pricing", "Subscribe", "terms.html", "pricing-verse-preview-strip", "Supporter verse cards", "id=\"auth-section\"", "id=\"sidebar-toggle\""]),
    ...
    ("/mobius.html", "Möbius Loop", ["Möbius Loop", "mobius-season-lead", "mobius-audio-roadmap", "human-narrated", "One ribbon for every season", "id=\"mobius-loop-journal\"", "mobius-deep-journal-input", "mobius-deep-journal-export", "mobius-v2-journal-input", "tdb-mobius-journal", "what-god-has-done.html", "KJV only", "mobius-text-v2.js", "mobius-guided-audio-human", "mobius-guided-human.mp3", "mobius-guided-voice-wrap"]),
    ...
    ("/plans.html", "Battle Plans", ["Battle Plans", "plan-list", "planIndex", "plans-audio-roadmap", "human narration", "id=\"plans-lane-foundations\"", "plans-lane-quick", "href=\"#plans-lane-pain\"", "id=\"plans-lane-uncertainty\"", "id=\"plans-lane-fear\"", "id=\"plans-lane-family\"", "id=\"planFamilyIntro\"", "plan-family-intro", "familyworship", "Family Worship in the Trenches", "psalmscomfortfamily", "Psalms of Comfort (Family Edition)", "hreflang=\"pt\" href=\"https://todaysdailybattle.com/pt/planos.html\"", "tdb-mobius-journal", "Save to loop journal", "mobius.html#mobius-loop-journal", "tdb-cache-hygiene:"]),
