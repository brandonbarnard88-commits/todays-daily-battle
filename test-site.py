...
PAGES = [
    ...
    ("/kids/index.html", "Kids Battle Home", ["Kids Battle", "Library deep links must hit corner.html", "location.replace('corner.html' + location.search)", "Read-along words, comic panels", "kids-battle.js?v=20260330kidslib", "kids-read-quiz-data.js?v=20260330kidslib", "kids-corner.js?v=20260330kidslib", "footer-humility", "We battle. He wins."]),
    ("/kids/corner.html", "Bible Story Library", ["/kids/corner.html?story=noah", "kids-story-library-og.jpg", "Download Story Library List (PDF)", "Bible Story Library", 'aria-describedby="pdf-export-count-hint pdf-export-hint"', "story-library-fonts.css?v=1", "kids-library-search-hint", "uFuzzy.iife.min.js", "kids-battle.js?v=20260330kidslib", "kids-read-quiz-data.js?v=20260330kidslib", "kids-corner.js?v=20260331kidsfuzzy", "hard-refresh", "canvas-confetti", "global-quiz-challenge", "print-qa-btn", "kids-print-qa-sheet-wrap", "TDB_PANEL_RASTER", "nunito-latin.woff2", "panel-david-1.svg"]),
    ("/kids/all-stories.html", "Kids All Stories A–Z", ["All Bible Stories", "bible-story-tool-index.js", "uFuzzy.iife.min.js", "kids-all-stories.js?v=20260331kidsfuzzy", "corner.html?story="]),
