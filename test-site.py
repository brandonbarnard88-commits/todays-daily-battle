...
PAGES = [
    ...
    ("/prayer-wall.html", "Quiet prayer room", ["id=\"prayer-wall\"", "id=\"prayer-wall-list\"", "What battle are you facing today?", "id=\"prayer-counter\"", "Total prayers", "message.html#message-board", "tt-bootstrap.js", "script.js?v=20260431idle", "tdb-cache-hygiene:"]),
    ...
    ("/verse-image.html", "Verse image generator", ["Verse image generator", "verse-image-canvas", "Supporter", "recent-gens", "data-verse-store", "verse-image-text-color", "verse-image-template", "Classic soar", "Peace &amp; hope", "Eagle flight", "cross", "value=\"soar\"", "dawn sky", "value=\"hush\"", "verse-image.js?v=20260403idb"]),
