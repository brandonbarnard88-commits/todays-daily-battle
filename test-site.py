...
PAGES = [
    ...
    ("/my-verses.html", "My Verses", ["My Verses", "my-verses-hero--soar-dawn", "id=\"my-verses-hero-heading\"", "id=\"saved-verses\"", "id=\"my-verses-panel\"", "bible-tool.html", "Study workspace", "styles.css?v=20260331surface-final", "don&rsquo;t use your list for ads", "footer-humility", "We battle. He wins.", "tdb-cache-hygiene:"]),
