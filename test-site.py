...
PAGES = [
    ...
    ("/bible-study.html", "Bible Study", ["Bible", "study-card-title", "Armor of God", "reading-plan.html?study=armor-of-god", "plans.html?plan=beatitudes", "plans.html?plan=peacemakers", "plans.html?plan=lordsprayer", "plans.html?plan=lordsprayer-kids", "plans.html?plan=sower", "Parable of the Sower", "plans.html?plan=sower-kids", "Parable of the Sower for Kids", "plans.html?plan=beatitudes-kids", "study-card-gentle-note", "Simple version for kids", "script.js?v=20260328studyhydrate", "id=\"auth-section\""]),
    ("/church-sharing-kit.html", "Church sharing kit", ["Church sharing kit", "id=\"church-sharing-kit-main\"", "csk-pre", "plans.html?plan=lordsprayer-kids", "https://todaysdailybattle.com/plans.html", "bible-study.html", "Small group", "Which study for which group", "docs/CHURCH-SHARING-KIT.md", "script.js?v=20260328feelwire", "id=\"auth-section\""]),
